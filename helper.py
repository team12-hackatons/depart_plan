...
from search.generate import generate_points
...
def main(start_point, end_point, icebreaker, ice_map):
    G = nx.Graph()
    ...
    current_time = icebreaker.current_time
    ...
    while True:
        ...
        if current_point.distance_to_end <= 10:
            ...
            break
        new_steps = generate_points(current_point, map_mask, visited, ice_map, icebreaker)
    ...
    if not is_path_exist:
        ...
        data.append({
            generate_random_id(): {
                ...
                "path": "Нужна проводка",
                # "speed": icebreaker['speed'],
                # "info": icebreaker['info'],
                "start_point": {
